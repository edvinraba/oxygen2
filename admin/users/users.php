...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="width: 80px; height: 90px;" ><?php echo $email;?></td>
            <td><?php echo $number;?></td>
            <td style="width: 270px;"><a href="update.php?update=<?php echo $id; ?>" id="a1">Update</a></td>
            
            <td style="width: 270px;"><a href="delete.php?delete=<?php echo $id; ?>" onclick="return confirm('A jeni i sigurt')" id="a2">Delete</a></td>
        </tr>
        <?php
            }
        }
